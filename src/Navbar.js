    ...
    <nav className="navbar">  
      <div className="navbar-container">
        <div className="dropdown">
          <button onClick={toggleDropdown} className="dropbtn">Display    
            <svg class="dd" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className={`dropdown-content ${showDropdown ? 'show' : ''}`}>
            ...
            <select className="second" onChange={(e) => setSortBy(e.target.value)}>
